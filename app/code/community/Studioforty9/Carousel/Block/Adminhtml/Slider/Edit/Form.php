...
/**
 * Studioforty9_Carousel_Block_Adminhtml_Slider_Edit_Form
 *
 * @category   Studioforty9
 * @package    Studioforty9_Carousel
 * @subpackage Block
 */
class Studioforty9_Carousel_Block_Adminhtml_Slider_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare the Slider admin form.
     *
     * @return mixed
     */
