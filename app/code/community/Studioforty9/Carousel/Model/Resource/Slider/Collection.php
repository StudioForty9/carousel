...
/**
 * Studioforty9_Carousel_Model_Resource_Slider_Collection
 *
 * @category   Studioforty9
 * @package    Studioforty9_Carousel
 * @subpackage Model
 */
class Studioforty9_Carousel_Model_Resource_Slider_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    /**
     * Create a list of dropdown options for the slider.
     *
     * @return array
     */
