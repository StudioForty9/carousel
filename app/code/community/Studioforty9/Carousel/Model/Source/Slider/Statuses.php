...
/**
 * Studioforty9_Carousel_Model_Source_Slider_Statuses
 *
 * @category   Studioforty9
 * @package    Studioforty9_Carousel
 * @subpackage Model
 */
class Studioforty9_Carousel_Model_Source_Slider_Statuses
{
    /**
    ...
    public function toOptionArray()
    {
        return array(
            array(
                'value' => Studioforty9_Carousel_Model_Slider::ENABLED,
                'label' => Mage::helper('studioforty9_carousel')->__('Enabled')
            ),
            array(
                'value' => Studioforty9_Carousel_Model_Slider::DISABLED,
