...
/**
 * Studioforty9_Carousel_Block_Adminhtml_Slider_Edit
 *
 * @category   Studioforty9
 * @package    Studioforty9_Carousel
 * @subpackage Block
 */
class Studioforty9_Carousel_Block_Adminhtml_Slider_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    protected function _construct()
    {
        ...
        $this->_headerText =  $newOrEdit . ' ' . $this->__('Slider');
